...
namespace CFria_HorasExtra
{
    public partial class FrmReporteSGeneral : Form
    {
        ...
        DataTableSemanalGeneralTableAdapter adapter = new DataTableSemanalGeneralTableAdapter();
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.adapter.Fill(this.dSReporteSemanal.DataTableSemanalGeneral, fechaInicioFormateada, fechaFinalFormateada);
